## gz_rendering_vendor (lyrical) - 0.4.4-1

The packages in the `gz_rendering_vendor` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --ros-distro lyrical gz_rendering_vendor` on `Wed, 29 Jul 2026 13:21:25 -0000`
...
## gz_rendering_vendor (rolling) - 0.5.0-1

The packages in the `gz_rendering_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_rendering_vendor` on `Thu, 14 May 2026 02:14:37 -0000`
...
## gz_rendering_vendor (rolling) - 0.4.3-1

The packages in the `gz_rendering_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_rendering_vendor` on `Thu, 22 Jan 2026 15:02:43 -0000`
...
## gz_rendering_vendor (kilted) - 0.2.6-1

The packages in the `gz_rendering_vendor` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted gz_rendering_vendor` on `Tue, 18 Nov 2025 16:31:31 -0000`
...
## gz_rendering_vendor (jazzy) - 0.0.7-1

The packages in the `gz_rendering_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy gz_rendering_vendor` on `Tue, 18 Nov 2025 16:29:23 -0000`
...
## gz_rendering_vendor (rolling) - 0.4.2-1

The packages in the `gz_rendering_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling --track rolling gz_rendering_vendor` on `Wed, 01 Oct 2025 15:46:29 -0000`
...
## gz_rendering_vendor (rolling) - 0.4.1-1

The packages in the `gz_rendering_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_rendering_vendor` on `Thu, 25 Sep 2025 04:59:32 -0000`
...
## gz_rendering_vendor (kilted) - 0.2.5-1
