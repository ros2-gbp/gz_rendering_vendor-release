...
%global pkg_name gz_rendering_vendor
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-gz-rendering-vendor
Version:        0.4.4
Release:        1%{?dist}
...
%description
Vendor package for: gz-rendering 10.0.2 Gazebo Rendering: Rendering library for
robot applications
...
%changelog
* Wed Jul 29 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.4.4-1
- Autogenerated by Bloom

* Thu Apr 30 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.4.3-3
- Autogenerated by Bloom

* Thu Apr 30 2026 Addisu Z. Taddese <addisuzt@intrinsic.ai> - 0.4.3-2
- Autogenerated by Bloom
